...
@ModuleInfo(name = "Trails", category = ModuleCategory.COSMETICS)
class Trails : Module() {
    private val typeValue = ListValue("Type", arrayOf("Line", "Rect", "Sphere", "Rise", "heart", "lava", "smoke", "cloud", "flame", "slime", "water", "firework"), "Rise")
