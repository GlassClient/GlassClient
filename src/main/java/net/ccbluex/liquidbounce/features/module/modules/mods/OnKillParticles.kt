...
@ModuleInfo(name = "OnKillParticles", category = ModuleCategory.MODS)
class OnKillParticles : Module() {

    private val modeValue = ListValue("Mode", arrayOf("Lighting", "Blood", "Fire", "Critical", "MagicCritical"), "Blood")
